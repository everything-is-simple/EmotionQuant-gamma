...
- **当前完整设计 SoT**：`blueprint/01-full-design/`
- **当前实现方案入口**：`blueprint/02-implementation-spec/01-current-mainline-implementation-spec-20260308.md`
- **当前执行拆解入口**：`blueprint/03-execution/01-current-mainline-execution-breakdown-20260308.md`
- **设计迁移边界声明**：`docs/design-migration-boundary.md`
- 分阶段文档统一归档至 `docs/spec/`；`docs/design-v2/` 仅保留历史基线与兼容桥接；参考资料统一位于 `docs/reference/`
...
详见：`blueprint/README.md`、`docs/design-migration-boundary.md` 与 `docs/spec/common/records/development-status.md`
...
| 目录 | 定位 |
|------|------|
| `blueprint/` | 新版设计权威层（完整设计 / 实现方案 / 执行拆解） |
| `docs/design-v2/` | 系统级历史基线与兼容桥接文档（`system-baseline.md` 为 `v0.01 Frozen` 历史基线） |
| `docs/spec/` | 分阶段治理与归档入口（按版本目录组织 roadmap/governance/evidence/records） |
| `docs/spec/common/records/` | 跨版本治理记录（development-status / debts / reusable-assets） |
| `docs/reference/` | 参考资料与外部方法论（非执行口径） |

### 8.2 单一事实源（SoT）

`docs/design-v2/01-system/system-baseline.md` 是 `v0.01 Frozen` 的历史权威文件；新版设计以 `blueprint/README.md` 与 `blueprint/01-full-design/` 为准；当前实现与推进以 `blueprint/02-implementation-spec/`、`blueprint/03-execution/` 与 `docs/spec/common/records/development-status.md` 为准。

### 8.3 归档规则

- 新版设计正文统一位于：`blueprint/`
- 分阶段治理与归档统一使用版本目录：`docs/spec/<version>/`
- 跨版本治理记录统一位于：`docs/spec/common/records/`
- `docs/design-v2/` 只保留历史基线与兼容桥接，不再新增新版设计正文
...
当前执行计划见 `blueprint/03-execution/01-current-mainline-execution-breakdown-20260308.md` 与 `docs/spec/common/records/development-status.md`；当前实现方案见 `blueprint/02-implementation-spec/01-current-mainline-implementation-spec-20260308.md`；`v0.01` 历史执行计划见 `docs/design-v2/01-system/system-baseline.md`。
