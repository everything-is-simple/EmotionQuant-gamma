...
$LegacyPatterns = @(
    ...
    'docs/design-v2/03-algorithms/core-algorithms/mss-api.md',
    'docs/design-v2/03-algorithms/core-algorithms/irs-api.md',
    'docs/design-v2/03-algorithms/core-algorithms/pas-api.md',
    'docs/design-v2/03-algorithms/core-algorithms/mss-data-models.md',
    'docs/design-v2/03-algorithms/core-algorithms/irs-data-models.md',
    'docs/design-v2/03-algorithms/core-algorithms/pas-data-models.md',
    'docs/design-v2/03-algorithms/core-algorithms/mss-information-flow.md',
    'docs/design-v2/03-algorithms/core-algorithms/irs-information-flow.md',
    'docs/design-v2/03-algorithms/core-algorithms/pas-information-flow.md',
