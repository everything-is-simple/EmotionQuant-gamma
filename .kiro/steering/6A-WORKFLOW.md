...
- 明确目标、范围、输入输出、风险。
- 挂接路线图位置（`.kiro/roadmap/roadmap.md` + 对应 `spec-*.md`）。
- 开工前硬门控（强制）：
...
- 同步最小集合（强制）：
  ...
  4. `.kiro/roadmap/roadmap.md`（阶段状态）
  5. 对应 `.kiro/roadmap/spec-*.md`（任务勾选/进度）
...
4. `.kiro/roadmap/roadmap.md`：更新对应周次状态（TODO/IN_PROGRESS/DONE）
5. 对应 `.kiro/roadmap/spec-*.md`：勾选本次完成项
