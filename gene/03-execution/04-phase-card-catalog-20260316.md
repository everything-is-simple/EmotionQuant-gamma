...
`第四战场已经不再有真正未执行的定义债卡；GX8 这张最后的三层 hierarchy 卡已完成。`

---

## 2. 原始主线卡

| Phase | 状态 | Card | Record | Evidence |
|---|---|---|---|---|
...
| Phase | 状态 | 说明 |
|---|---|---|
| `GX1` | `Conditional only` | 仅在 detector 一致性重新成为主阻塞时才允许打开 |
| `GX2` | `Conditional only` | 仅在 Gene 研究线内部需要单独迁移包时才允许打开 |

---

## 4. Closeout 后 Targeted Hypothesis
...
| `GX21` | `Active` | [`card`](32-phase-gx21-gene-incremental-builder-card-20260320.md) | `builder_linked` | `eval_and_conditioning_refresh_linked` | Gene 与四张寿命面按脏窗口增量更新 |
