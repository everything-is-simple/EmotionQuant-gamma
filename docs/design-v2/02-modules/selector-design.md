...
> - 仓库现行 `Selector` 设计已迁入 `blueprint/01-full-design/03-selector-contract-supplement-20260308.md` 与 `blueprint/02-implementation-spec/01-current-mainline-implementation-spec-20260308.md`。
...
- 仓库现行 `Selector` 设计已迁出冻结区，详见 `blueprint/01-full-design/03-selector-contract-supplement-20260308.md` 与 `blueprint/02-implementation-spec/01-current-mainline-implementation-spec-20260308.md`。
