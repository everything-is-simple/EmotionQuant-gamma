...
4. 若本文历史段落与 `docs/design-v2/rebuild-v0.01.md` 冲突，以 `rebuild-v0.01.md` 为准。
...
| `l3_signals` | PAS 每日信号历史 | pas_bof.py（v0.01） | signal_id, code, signal_date, action, strength, pattern |
