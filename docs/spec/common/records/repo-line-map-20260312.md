...
1. 独立研究战场
2. 用于证明 `raw alpha provenance`
3. 用于拆解 `exit damage / execution damage`
4. 不直接改写当前主线 SoT

当前必须明确写死：

`Normandy 不是 v0.01 的子版本号，也不是新的版本线。`
...
1. `Normandy` 可以找到答案
2. 但它不能靠自身目录结构直接变成新主线

---

## 5. 当前仓库一句话口径

`docs/design-v2/` 是历史线，`blueprint/` 是主线，`normandy/` 是研究线，`docs/spec/common/records/` 是跨线状态账本。`
