...
`docs/spec/common/` 存放跨版本共用的治理记录，以及少量需要长期保留的历史审计材料。
这里回答的是“哪些材料需要跨版本持续维护”，不是“当前系统设计怎么定义”。

当前阶段与主线判定以 `docs/spec/common/records/development-status.md` 为准；
版本归档入口统一在 `docs/spec/`；
历史审计材料统一收进 `records/` 及其下级归档层。
...
| 历史审计归档 | `records/90-archive/README.md` | 查看已退场的历史桥接审计与治理转折材料 |
