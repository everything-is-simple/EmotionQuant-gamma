...
> **版本**: v0.01 | **状态**: Active | **REV-ID**: `REV-v0.01-S03-20260304` | **基线**: `docs/design-v2/system-baseline.md` | **评审标准**: `docs/design-v2/sandbox-review-standard.md`
...
1. `docs/design-v2/strategy-design.md`
2. `docs/design-v2/volman-ytc-mapping.md`
