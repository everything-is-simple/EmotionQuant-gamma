...
当前执行与归档统一在 `docs/spec/v0.01/`。`docs/design-v2/01-system/system-baseline.md` 是 `v0.01 Frozen` 的历史设计基线；当前治理状态与是否继续回看 `v0.01`，以 `docs/spec/common/records/development-status.md` 为准。
...
3. 若与系统设计口径冲突，以 `docs/design-v2/01-system/system-baseline.md` 为准；当前主开发线问题不在本目录裁决。
