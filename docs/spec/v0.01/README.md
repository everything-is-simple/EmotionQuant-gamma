...
本目录存放 `v0.01` 的阶段性全量材料，按“生成目的”整理如下：

1. `roadmap/`：路线图、实现卡、实现卡模板
2. `governance/`：边界规则、数据契约、Gate 清单
3. `evidence/`：回测/幂等/G6 等评审证据
4. `records/`：runbook、勘误、封版记录、待确认删除清单

当前执行与归档统一在 `docs/spec/v0.01/`。
