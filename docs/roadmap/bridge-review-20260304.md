...
**审查范围**:
- `docs/roadmap/v0.01-mvp.md` ~ `v0.06-portfolio.md`
- `docs/design-v2/architecture-master.md`、`backtest-report-design.md`、`broker-design.md`、`data-layer-design.md`、`data-rebuild-runbook-20260303.md`、`rebuild-v0.01.md`、`release-v0.01-formal.md`、`sandbox-review-standard.md`、`selector-design.md`、`strategy-design.md`、`volman-ytc-mapping.md`
- `docs/reference/未来之路/god_view_8_perspectives_report_v0.01.md`

**审查基线**:
- 执行口径：`docs/design-v2/rebuild-v0.01.md`
